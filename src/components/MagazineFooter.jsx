import { Google, Instagram, LinkedIn, Twitter, Whatsapp, FaceBook, Youtube } from './Icons';
import { Link } from 'react-router-dom';

const MagazineFooter = () => {
  return (
<footer className='bg-primaryColor flex flex-col gap-8 px-6 md:px-16 py-8 text-white'>
