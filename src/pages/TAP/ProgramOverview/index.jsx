		...
		<section
			...
			<div className="flex flex-col space-y-4 ">
				<p className="">
					...
					specialized, hands-on internship that bridges the gap
					between education and real-world experience. Designed for
					aspiring tech professionals, TAP offers a unique opportunity
					to help techies gain experience, collaborate on cutting-edge
					projects and develop market-ready skills to become
					employable.
				</p>
				<p className="">
